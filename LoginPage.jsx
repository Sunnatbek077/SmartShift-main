            ...
            <div className="login-card">
              ...
              <div className="login-panel">
                ...
                <button 
                  ...
                  onClick={() => { setSelectedRole('professor'); setShowRegister(false); setShowAdminLogin(false); }}
                >
                  <div className="icon">
                ...
                <button 
                  ...
                  onClick={() => { setSelectedRole('student'); setShowRegister(false); setShowAdminLogin(false); }}
                >
                  <div className="icon">
